	...
	module Category
		class Tagcloud_Info < Info
			def years
				...
				case now_month
				when 1
					r["#{now_year - 1}"] = ['02','03','04','05','06','07','08','09','10','11','12']
				when 2
					r["#{now_year - 1}"] = ['03','04','05','06','07','08','09','10','11','12']
				when 3
					r["#{now_year - 1}"] = ['04','05','06','07','08','09','10','11','12']
				when 4
					r["#{now_year - 1}"] = ['05','06','07','08','09','10','11','12']
				when 5
					r["#{now_year - 1}"] = ['06','07','08','09','10','11','12']
				when 6
					r["#{now_year - 1}"] = ['07','08','09','10','11','12']
				when 7
					r["#{now_year - 1}"] = ['08','09','10','11','12']
				when 8
					r["#{now_year - 1}"] = ['09','10','11','12']
				when 9
					r["#{now_year - 1}"] = ['10','11','12']
				when 10
					r["#{now_year - 1}"] = ['11','12']
				when 11
					r["#{now_year - 1}"] = ['12']
